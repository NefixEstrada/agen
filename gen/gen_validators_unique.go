// Vendored from ogen v1.24.0 gen/gen_validators_unique.go.
// Local deltas: header "by agen", file name aas_validators_unique_gen.go,
// validate import path points at agen/runtime/validate.
...
func (g *Generator) generateUniqueValidators(fs FileSystem, pkgName string) error {
	...
	// File header
	fmt.Fprintf(&b, "// Code generated by agen, DO NOT EDIT.\n\n")
	fmt.Fprintf(&b, "package %s\n\n", pkgName)
	fmt.Fprintf(&b, "import (\n")
	fmt.Fprintf(&b, "\t\"github.com/NefixEstrada/agen/runtime/validate\"\n")
	fmt.Fprintf(&b, ")\n\n")
	...
	filename := "aas_validators_unique_gen.go"
