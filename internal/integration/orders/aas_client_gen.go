...
// SendOrderEvents publishes a message of the "sendOrderEvents" operation.
func (c *Client) SendOrderEvents(ctx context.Context, tenantId string, msg OrderEventsMessage, opts ...PublishOption) error {
	topic, err := BuildOrderEventsAddress(tenantId)
	if err != nil {
		return err
	}
	out, err := encodeSendOrderEventsMessage(topic, msg, opts...)
	if err != nil {
		return err
	}
