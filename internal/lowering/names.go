...
// PascalSpecialInitialisms converts a string to PascalCase applying the
// initialism rules (e.g. "Id" -> "ID"), allowing special characters.
func PascalSpecialInitialisms(strs ...string) (string, error) {
	return namer{initialisms: true}.pascalSpecial(strs...)
}
